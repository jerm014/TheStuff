# Project 2180: C - Stacks, Queues - LIFO, FIFO
----
...
* If the file contains an invalid instruction, print the error message`L<line_number>: unknown instruction <opcode>`, followed by a new line, and exit with the status`EXIT_FAILURE`
  * whereis the line number where the instruction appears.
  ...
  * You have to use`malloc`and`free`and are not allowed to use any other function from`man malloc`(realloc, calloc, …)**Great!**You've completed the quiz successfully! Keep going!#### Question #0

Which of these methods are keeping the order of insertion? (select all possible answers)
