# Project 2366: Unittests and Integration Tests
----
...
Familiarize yourself with the <!--plain-NL-->`utils.access_nested_map`<!--inline-NL--> function and understand its purpose. Play with it in the Python console to make sure you understand.<!--plain-NL-->

In this task you will write the first unit test for <!--plain-NL-->`utils.access_nested_map`<!--inline-NL-->.<!--plain-NL-->

Create a <!--plain-NL-->`TestAccessNestedMap`<!--inline-NL--> class that inherits from <!--plain-NL-->`unittest.TestCase`<!--inline-NL-->.<!--plain-NL-->

Implement the <!--plain-NL-->`TestAccessNestedMap.test_access_nested_map`<!--inline-NL--> method to test that the method returns what it is supposed to.<!--plain-NL-->

Decorate the method with <!--plain-NL-->`@parameterized.expand`<!--inline-NL--> to test the function for following inputs:<!--plain-NL-->
...
For each of these inputs, test with <!--plain-NL-->`assertEqual`<!--inline-NL--> that the function returns the expected result.<!--plain-NL-->

The body of the test method should not be longer than 2 lines.<!--plain-NL-->
...
Implement <!--plain-NL-->`TestAccessNestedMap.test_access_nested_map_exception`<!--inline-NL-->. Use the <!--plain-NL-->`assertRaises`<!--inline-NL--> context manager to test that a <!--plain-NL-->`KeyError`<!--inline-NL--> is raised for the following inputs (use <!--plain-NL-->`@parameterized.expand`<!--inline-NL-->):<!--plain-NL-->
...
Also make sure that the exception message is as expected.<!--plain-NL-->
...
Familiarize yourself with the <!--plain-NL-->`utils.get_json`<!--inline-NL--> function.<!--plain-NL-->

Define the <!--plain-NL-->`TestGetJson(unittest.TestCase)`<!--inline-NL--> class and implement the <!--plain-NL-->`TestGetJson.test_get_json`<!--inline-NL--> method to test that <!--plain-NL-->`utils.get_json`<!--inline-NL--> returns the expected result.<!--plain-NL-->

We don’t want to make any actual external HTTP calls. Use <!--plain-NL-->`unittest.mock.patch`<!--inline-NL--> to patch <!--plain-NL-->`requests.get`<!--inline-NL-->. Make sure it returns a <!--plain-NL-->`Mock`<!--inline-NL--> object with a <!--plain-NL-->`json`<!--inline-NL--> method that returns <!--plain-NL-->`test_payload`<!--inline-NL--> which you parametrize alongside the <!--plain-NL-->`test_url`<!--inline-NL--> that you will pass to <!--plain-NL-->`get_json`<!--inline-NL--> with the following inputs:<!--plain-NL-->
...
Test that the mocked <!--plain-NL-->`get`<!--inline-NL--> method was called exactly once (per input) with <!--plain-NL-->`test_url`<!--inline-NL--> as argument.<!--plain-NL-->

Test that the output of <!--plain-NL-->`get_json`<!--inline-NL--> is equal to <!--plain-NL-->`test_payload`<!--inline-NL-->.<!--plain-NL-->
...
Read about memoization and familiarize yourself with the <!--plain-NL-->`utils.memoize`<!--inline-NL--> decorator.<!--plain-NL-->

Implement the <!--plain-NL-->`TestMemoize(unittest.TestCase)`<!--inline-NL--> class with a <!--plain-NL-->`test_memoize`<!--inline-NL--> method.<!--plain-NL-->

Inside <!--plain-NL-->`test_memoize`<!--inline-NL-->, define following class<!--plain-NL-->
...
Use <!--plain-NL-->`unittest.mock.patch`<!--inline-NL--> to mock <!--plain-NL-->`a_method`<!--inline-NL-->. Test that when calling <!--plain-NL-->`a_property`<!--inline-NL--> twice, the correct result is returned but <!--plain-NL-->`a_method`<!--inline-NL--> is only called once using <!--plain-NL-->`assert_called_once`<!--inline-NL-->.<!--plain-NL-->
...
Familiarize yourself with the <!--plain-NL-->`client.GithubOrgClient`<!--inline-NL--> class.<!--plain-NL-->

In a new <!--plain-NL-->`test_client.py`<!--inline-NL--> file, declare the <!--plain-NL-->`TestGithubOrgClient(unittest.TestCase)`<!--inline-NL--> class and implement the <!--plain-NL-->`test_org`<!--inline-NL--> method.<!--plain-NL-->

This method should test that <!--plain-NL-->`GithubOrgClient.org`<!--inline-NL--> returns the correct value.<!--plain-NL-->

Use <!--plain-NL-->`@patch`<!--inline-NL--> as a decorator to make sure <!--plain-NL-->`get_json`<!--inline-NL--> is called once with the expected argument but make sure it is not executed.<!--plain-NL-->

Use <!--plain-NL-->`@parameterized.expand`<!--inline-NL--> as a decorator to parametrize the test with a couple of <!--plain-NL-->`org`<!--inline-NL--> examples to pass to <!--plain-NL-->`GithubOrgClient`<!--inline-NL-->, in this order:<!--plain-NL-->

- `google`
- `abc`

Of course, no external HTTP calls should be made.<!--plain-NL-->
...
`memoize`<!--inline-NL--> turns methods into properties. Read up on how to mock a property (see resource).<!--plain-NL-->

Implement the <!--plain-NL-->`test_public_repos_url`<!--inline-NL--> method to unit-test <!--plain-NL-->`GithubOrgClient._public_repos_url`<!--inline-NL-->.<!--plain-NL-->

Use <!--plain-NL-->`patch`<!--inline-NL--> as a context manager to patch <!--plain-NL-->`GithubOrgClient.org`<!--inline-NL--> and make it return a known payload.<!--plain-NL-->

Test that the result of <!--plain-NL-->`_public_repos_url`<!--inline-NL--> is the expected one based on the mocked payload.<!--plain-NL-->
...
Implement <!--plain-NL-->`TestGithubOrgClient.test_public_repos`<!--inline-NL--> to unit-test <!--plain-NL-->`GithubOrgClient.public_repos`<!--inline-NL-->.<!--plain-NL-->

Use <!--plain-NL-->`@patch`<!--inline-NL--> as a decorator to mock <!--plain-NL-->`get_json`<!--inline-NL--> and make it return a payload of your choice.<!--plain-NL-->

Use <!--plain-NL-->`patch`<!--inline-NL--> as a context manager to mock <!--plain-NL-->`GithubOrgClient._public_repos_url`<!--inline-NL--> and return a value of your choice.<!--plain-NL-->

Test that the list of repos is what you expect from the chosen payload.<!--plain-NL-->

Test that the mocked property and the mocked <!--plain-NL-->`get_json`<!--inline-NL--> was called once.<!--plain-NL-->
...
Implement <!--plain-NL-->`TestGithubOrgClient.test_has_license`<!--inline-NL--> to unit-test <!--plain-NL-->`GithubOrgClient.has_license`<!--inline-NL-->.<!--plain-NL-->

Parametrize the test with the following inputs<!--plain-NL-->
...
You should also parameterize the expected returned value.<!--plain-NL-->
...
We want to test the <!--plain-NL-->`GithubOrgClient.public_repos`<!--inline-NL--> method in an integration test. That means that we will only mock code that sends external requests.<!--plain-NL-->

Create the <!--plain-NL-->`TestIntegrationGithubOrgClient(unittest.TestCase)`<!--inline-NL--> class and implement the <!--plain-NL-->`setUpClass`<!--inline-NL--> and <!--plain-NL-->`tearDownClass`<!--inline-NL--> which are part of the <!--plain-NL-->`unittest.TestCase`<!--inline-NL--> API.<!--plain-NL-->

Use <!--plain-NL-->`@parameterized_class`<!--inline-NL--> to decorate the class and parameterize it with fixtures found in <!--plain-NL-->`fixtures.py`<!--inline-NL-->. The file contains the following fixtures:<!--plain-NL-->
...
The <!--plain-NL-->`setupClass`<!--inline-NL--> should mock <!--plain-NL-->`requests.get`<!--inline-NL--> to return example payloads found in the fixtures.<!--plain-NL-->

Use <!--plain-NL-->`patch`<!--inline-NL--> to start a patcher named <!--plain-NL-->`get_patcher`<!--inline-NL-->, and use <!--plain-NL-->`side_effect`<!--inline-NL--> to make sure the mock of <!--plain-NL-->`requests.get(url).json()`<!--inline-NL--> returns the correct fixtures for the various values of <!--plain-NL-->`url`<!--inline-NL--> that you anticipate to receive.<!--plain-NL-->

Implement the <!--plain-NL-->`tearDownClass`<!--inline-NL--> class method to stop the patcher.<!--plain-NL-->
