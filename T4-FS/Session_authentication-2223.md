# Project 2223: Session authentication
----
...
Copy all your work of the <!--plain-->[0x06. Basic authentication](https://intranet.hbtn.io/projects/380/) <!--link--> project in this new folder.<!--plain-->

In this version, you implemented a <!--plain-NL-->**Basic authentication**<!--code-NL--> for giving you access to all User endpoints:<!--plain-NL-->
...
Now, you will add a new endpoint: <!--plain-NL-->`GET /users/me`<!--inline-NL--> to retrieve the authenticated <!--plain-NL-->`User`<!--inline-NL--> object.<!--plain-NL-->
...
Create a class <!--plain-NL-->`SessionAuth`<!--inline-NL--> that inherits from <!--plain-NL-->`Auth`<!--inline-NL-->. For the moment this class will be empty. It’s the first step for creating a new authentication mechanism:<!--plain-NL-->

- validate if everything inherits correctly without any overloading
- validate the “switch” by using environment variables

Update <!--plain-NL-->`api/v1/app.py`<!--inline-NL--> for using <!--plain-NL-->`SessionAuth`<!--inline-NL--> instance for the variable <!--plain-NL-->`auth`<!--inline-NL--> depending of the value of the environment variable <!--plain-NL-->`AUTH_TYPE`<!--inline-NL-->, If <!--plain-NL-->`AUTH_TYPE`<!--inline-NL--> is equal to <!--plain-NL-->`session_auth`<!--inline-NL-->:<!--plain-NL-->

- import `SessionAuth` from `api.v1.auth.session_auth`
- create an instance of `SessionAuth` and assign it to the variable `auth`

Otherwise, keep the previous mechanism.<!--plain-NL-->
...
Update <!--plain-NL-->`SessionAuth`<!--inline-NL--> class:<!--plain-NL-->
...
Now you an “in-memory” Session ID storing. You will be able to retrieve an <!--plain-NL-->`User`<!--inline-NL--> id based on a Session ID.<!--plain-NL-->
...
Create an instance method <!--plain-NL-->`def user_id_for_session_id(self, session_id: str = None) -> str:`<!--inline-NL--> that returns a <!--plain-NL-->`User`<!--inline-NL--> ID based on a Session ID:<!--plain-NL-->
...
Now you have 2 methods (<!--plain-NL-->`create_session`<!--inline-NL--> and <!--plain-NL-->`user_id_for_session_id`<!--inline-NL-->) for storing and retrieving a link between a <!--plain-NL-->`User`<!--inline-NL--> ID and a Session ID.<!--plain-NL-->
...
Update <!--plain-NL-->`api/v1/auth/auth.py`<!--inline-NL--> by adding the method <!--plain-NL-->`def session_cookie(self, request=None):`<!--inline-NL--> that returns a cookie value from a request:<!--plain-NL-->
...
Update the <!--plain-NL-->`@app.before_request`<!--inline-NL--> method in <!--plain-NL-->`api/v1/app.py`<!--inline-NL-->:<!--plain-NL-->
...
Create an instance method <!--plain-NL-->`def current_user(self, request=None):`<!--inline-NL--> (overload) that returns a <!--plain-NL-->`User`<!--inline-NL--> instance based on a cookie value:<!--plain-NL-->

- You must use `self.session_cookie(...)` and `self.user_id_for_session_id(...)` to return the User ID based on the cookie `_my_session_id`
- By using this User ID, you will be able to retrieve a `User` instance from the database - you can use `User.get(...)` for retrieving a `User` from the database.

Now, you will be able to get a User based on his session ID.<!--plain-NL-->
...
Create a new Flask view that handles all routes for the Session authentication.<!--plain-NL-->

In the file <!--plain-NL-->`api/v1/views/session_auth.py`<!--inline-NL-->, create a route <!--plain-NL-->`POST /auth_session/login`<!--inline-NL--> (= <!--plain-NL-->`POST /api/v1/auth_session/login`<!--inline-NL-->):<!--plain-NL-->
...
In the file <!--plain-NL-->`api/v1/views/__init__.py`<!--inline-NL-->, you must add this new view at the end of the file.<!--plain-NL-->
...
Now you have an authentication based on a Session ID stored in cookie, perfect for a website (browsers love cookies).<!--plain-NL-->
...
Update the class <!--plain-NL-->`SessionAuth`<!--inline-NL--> by adding a new method <!--plain-NL-->`def destroy_session(self, request=None):`<!--inline-NL--> that deletes the user session / logout:<!--plain-NL-->
...
Update the file <!--plain-NL-->`api/v1/views/session_auth.py`<!--inline-NL-->, by adding a new route <!--plain-NL-->`DELETE /api/v1/auth_session/logout`<!--inline-NL-->:<!--plain-NL-->
...
Login, logout… what’s else?<!--plain-NL-->

Now, after getting a Session ID, you can request all protected API routes by using this Session ID, no need anymore to send User email and password every time.<!--plain-NL-->
