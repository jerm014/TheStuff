...
Write the big O notations for the following lists operations (one per line, in this exact order):<!--plain-NL-->
...
CPython is the reference implementation of the Python programming language. Written in C, CPython is the default and most widely used implementation of the language.<!--plain-NL-->
Since we now know a bit of C, we can look at what is happening under the hood of Python. Let’s have fun with Python and C, and let’s look at what makes Python so easy to use.<!--plain-NL-->


<!--plain-NL-->
Create a C function that prints some basic info about Python lists.<!--plain-NL-->
...
Create two C functions that print some basic info about Python lists and Python bytes objects.<!--plain-NL-->
<!--plain-NL-->
<!--plain-NL-->
<!--plain-NL-->
Python lists:<!--plain-NL-->
...
Create three C functions that print some basic info about Python lists, Python bytes an Python float objects.<!--plain-NL-->
<!--plain-NL-->
<!--plain-NL-->
<!--plain-NL-->
Python lists:<!--plain-NL-->
...
Create a function that prints Python strings.<!--plain-NL-->
...
Create a C function that prints Python integers.<!--plain-NL-->
