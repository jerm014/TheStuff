...
* [Basic query operation: the join](https://web.archive.org/sry?page=sql/join.php)
* [SQL technique: multiple joins and the distinct keyword](https://web.archive.org/sry?page=sql/multijoin.php)
* [SQL technique: join types](https://web.archive.org/sry?page=sql/jointypes.php)
* [SQL technique: union and minus](https://web.archive.org/sry?page=sql/setops.php)
